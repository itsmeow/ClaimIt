...
public class ClaimPermissions {
	...
	public static final ClaimPermissionToggle MODIFY_TOGGLE = new ClaimPermissionToggle("modify", false, "Allows modification of blocks for all users if enabled.", false, false);
	public static final ClaimPermissionToggle USE_TOGGLE = new ClaimPermissionToggle("use", false, "Allows use of items (flint and steel, etc), interactions with blocks (chests, furnaces, doors, levers), and interactions with entities (shearing sheep) for all users if enabled.", false, false);
